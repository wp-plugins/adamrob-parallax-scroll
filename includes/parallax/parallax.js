...
;(function ( $, window, document, undefined ) {
  ...
  function Parallax(element, options) {
    ...
    if (navigator.userAgent.match(/(iPod|iPhone|iPad)/)) {
      if (this.iosFix && !this.$element.is('img')) {
        this.$element.css({
          ...
          backgroundImage: 'url(' + this.imageSrc + ')',  //adamrob.co.uk - 1OCT2014 - IOS Image Fix
    ...
    //adamrob.co.uk - 10OCT2014 - Added Android Fix
  ...
  $.extend(Parallax.prototype, {
    ...
    zIndex:   -100,
    iosFix:   true,
    androidFix:   true, //adamrob.co.uk - 1OCT2014 - added android fix parr
    position: 'center',
